...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def(
        ...
        &gsplat::fully_fused_projection_fwd_tensor);
    m.def(
        "fully_fused_projection_bwd",
        &gsplat::fully_fused_projection_bwd_tensor);
    ...
    m.def(
        "equir_fully_fused_projection_fwd_2dgs",
        &gsplat::equir_fully_fused_projection_fwd_2dgs_tensor);
    m.def(
        "fully_fused_projection_bwd_2dgs",
        &gsplat::fully_fused_projection_bwd_2dgs_tensor);
    m.def(
        "equir_fully_fused_projection_bwd_2dgs",
        &gsplat::equir_fully_fused_projection_bwd_2dgs_tensor);
    ...
    m.def(
        "equir_rasterize_to_pixels_fwd_2dgs",
        &gsplat::equir_rasterize_to_pixels_fwd_2dgs_tensor);
    m.def(
        "rasterize_to_pixels_bwd_2dgs",
        &gsplat::rasterize_to_pixels_bwd_2dgs_tensor);
    m.def(
        "equir_rasterize_to_pixels_bwd_2dgs",
        &gsplat::equir_rasterize_to_pixels_bwd_2dgs_tensor);
