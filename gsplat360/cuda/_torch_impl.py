...
def _quat_scale_to_covar_preci(
    ...
    """PyTorch implementation of `gsplat360.cuda._wrapper.quat_scale_to_covar_preci()`."""
    R = _quat_to_rotmat(quats)  # (..., 3, 3)
...
def _fully_fused_projection(
    ...
    """PyTorch implementation of `gsplat360.cuda._wrapper.fully_fused_projection()`
...
def _isect_tiles(
    ...
    """Pytorch implementation of `gsplat360.cuda._wrapper.isect_tiles()`.
...
def _isect_offset_encode(isect_ids: Tensor, C: int, tile_width: int, tile_height: int) -> Tensor:
    """Pytorch implementation of `gsplat360.cuda._wrapper.isect_offset_encode()`.
...
def accumulate(
    ...
    `gsplat360.rasterize_to_indices_in_range`.
...
def _rasterize_to_pixels(
    ...
    """Pytorch implementation of `gsplat360.cuda._wrapper.rasterize_to_pixels()`.
...
def _spherical_harmonics(
    ...
    """Pytorch implementation of `gsplat360.cuda._wrapper.spherical_harmonics()`."""
